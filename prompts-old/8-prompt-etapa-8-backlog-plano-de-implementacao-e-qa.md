...
27. **Diretrizes de UX/UI derivadas de `0-estetica-inicial-{nome-do-produto}.md`**
...
9. Não ignore o arquivo `0-estetica-inicial-{nome-do-produto}.md`.
...
<body>
  ...
  <main class="content">
    ...
    <section id="casos-teste">
      <!-- Casos de Teste -->
    </section>

    <section id="testes-permissao">
      <!-- Testes de Permissão -->
    </section>

    <section id="testes-ux-ui">
      <!-- Testes de UX/UI -->
    </section>
    ...
    <section id="testes-dados-auditoria">
      <!-- Testes de Dados e Auditoria -->
    </section>

    <section id="riscos-implementacao">
...
17. Salve o arquivo com o padrão `8-{nome-do-produto}.html`.

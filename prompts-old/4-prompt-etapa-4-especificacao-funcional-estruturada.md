...
```txt
4-{nome-do-produto}.html
```

Exemplo:

```txt
4-especificacao-funcional-estruturada-agentops.html
```
...
- detalhar módulos por domínio;
- detalhar funcionalidades por módulo;
- identificar telas por funcionalidade;
- mapear ações e eventos de cada tela;
- mapear regras de negócio iniciais;
...
## 6. Mapear funcionalidades por módulo
...
## 7. Mapear telas por funcionalidade
...
## 9. Mapear regras de negócio iniciais
...
## 13. Mapear integrações candidatas
...
22. **Diretrizes de UX/UI derivadas de `0-estetica-inicial-{nome-do-produto}.md`**
...
- total de perfis;
- total de integrações candidatas;
...
<body>
  ...
  <main class="content">
    ...
    <section id="automacoes-ia">
      <!-- Automações e IA -->
    </section>

    <section id="relatorios-dashboards">
      <!-- Relatórios e dashboards -->
    </section>

    <section id="estados-mensagens">
    ...
    <section id="recomendacoes-etapa-5">
      <!-- Recomendações para a Etapa 5 -->
    </section>
...
5. Não ignore o arquivo `0-estetica-inicial-{nome-do-produto}.md`.
6. Não crie estética paralela à estética oficial.
7. Não invente fontes, dados ou validações.
8. Não use links fictícios.
9. Não dependa de bibliotecas externas no HTML.
10. Não entregue apenas Markdown.
11. Não gere arquivos separados.
12. Gere apenas um HTML final, analise o conteúdo do HTML e procure por erros ou falhas e corrija.
13. Salve o arquivo com o padrão `4-{nome-do-produto}.html`.
14. Responda somente com o link para download e uma frase curta de confirmação.

...
Quando houver conflito entre instruções genéricas deste prompt e a definição estética do arquivo `0-estetica-inicial.md`, prevalece o arquivo de estética.
...
A seção **Direção Estética Aplicada da Etapa 1.1** deve resumir como o arquivo `0-estetica-inicial.md` foi aplicado ao dashboard, incluindo decisões de tema, hierarquia, composição, densidade, componentes e estados visuais.
...
- CSS embutido;
- JavaScript embutido;
- layout responsivo conforme a composição, densidade e hierarquia definidas em `0-estetica-inicial.md`;
...
O cabeçalho deve seguir a composição, hierarquia, tom e identidade definidos em `0-estetica-inicial.md`.
...
Criar cards conforme o estilo de componentes, densidade, espaçamento, bordas, cores e hierarquia definidos em `0-estetica-inicial.md`, contendo:
...
Para cada pergunta, criar um card ou seção expansível de acordo com os padrões visuais definidos em `0-estetica-inicial.md`, contendo:
...
1. Antes de criar o HTML, extraia do arquivo `0-estetica-inicial.md` as diretrizes relevantes de:
   - personalidade visual;
   - direção criativa;
   - linguagem estética;
...
O dashboard deve conter, de forma compatível com `0-estetica-inicial.md`:
...
Evite qualquer escolha visual que contradiga o arquivo `0-estetica-inicial.md`, especialmente:
...
<body>
  ...
  <main class="content" data-objetivo="Centralizar o conteúdo da Etapa 1.2, reunindo contexto, decisões, regras e entregas esperadas em um único ponto de referência para orientar a produção do artefato final e a continuidade do fluxo de trabalho.">
    <header class="hero">
    ...
    <section id="contexto-produto" data-objetivo="Detalhar Contexto extraído do HTML da Etapa 1 para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Contexto extraído do HTML da Etapa 1 -->
    </section>

    <section id="direcao-estetica" data-objetivo="Detalhar Resumo da direção estética aplicada a partir de 0-estetica-inicial.md para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Resumo da direção estética aplicada a partir de 0-estetica-inicial.md -->
    </section>

    <section id="perguntas-extraidas" data-objetivo="Detalhar Lista de perguntas extraídas para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Lista de perguntas extraídas -->
    </section>

    <section id="mapa-categorias" data-objetivo="Detalhar Agrupamento por categoria para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Agrupamento por categoria -->
    </section>

    <section id="tabela-consolidada" data-objetivo="Detalhar Tabela consolidada para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Tabela consolidada -->
    </section>

    <section id="analises-detalhadas" data-objetivo="Detalhar Respostas pesquisadas por pergunta para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Respostas pesquisadas por pergunta -->
    </section>

    <section id="aprendizados" data-objetivo="Detalhar Principais aprendizados para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Principais aprendizados -->
    </section>

    <section id="implicacoes" data-objetivo="Detalhar Implicações para o produto para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Implicações para o produto -->
    </section>

    <section id="decisoes" data-objetivo="Detalhar Decisões sugeridas para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Decisões sugeridas -->
    </section>

    <section id="riscos-atualizados" data-objetivo="Detalhar Riscos atualizados para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Riscos atualizados -->
    </section>

    <section id="oportunidades-atualizadas" data-objetivo="Detalhar Oportunidades atualizadas para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Oportunidades atualizadas -->
    </section>

    <section id="hipoteses" data-objetivo="Detalhar Hipóteses reduzidas, confirmadas parcialmente e novas hipóteses para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Hipóteses reduzidas, confirmadas parcialmente e novas hipóteses -->
    </section>

    <section id="lacunas-validacao" data-objetivo="Detalhar Lacunas restantes para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Lacunas restantes -->
    </section>

    <section id="entrevistas" data-objetivo="Detalhar Recomendações para entrevistas para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Recomendações para entrevistas -->
    </section>

    <section id="benchmarking" data-objetivo="Detalhar Recomendações para benchmarking da Etapa 2 para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
...
12. Salve o arquivo com o padrão `1.2.html`.

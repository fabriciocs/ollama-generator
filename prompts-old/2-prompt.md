...
1. Um arquivo `.html` da Etapa 1.
2. Um arquivo `.html` da Etapa 1.2.
3. Um arquivo `.md` da Etapa 0.
...
Pesquise na internet por sistemas, plataformas, aplicativos, SaaS, ERPs, CRMs, marketplaces, ferramentas internas, automações ou serviços relacionados ao produto.
...
- 10 concorrentes ou soluções semelhantes diretas;
- 5 concorrentes indiretos ou substitutos;
- 5 benchmarks aspiracionais;
- 5 referências de UX, onboarding, dashboards ou fluxos;
- 5 referências de monetização ou planos;
- 5 referências de tendências relevantes do mercado.
...
- CSS embutido;
- JavaScript embutido;
- layout responsivo conforme a arquitetura visual, densidade, grids e comportamento mobile definidos em `0-estetica-inicial.md`;
- navegação lateral construída conforme o padrão de navegação, hierarquia, ritmo e linguagem visual definidos em `0-estetica-inicial.md`;
- cards de resumo desenhados conforme o sistema de componentes, densidade informacional e estilo visual definidos em `0-estetica-inicial.md`;
- tabelas;
- seções expansíveis;
- filtros;
- busca textual;
- indicadores visuais coerentes com a paleta, semântica de status, tokens, contrastes e linguagem visual definidos em `0-estetica-inicial.md`;
- gráficos simples em HTML/CSS/JavaScript puro, visualmente compatíveis com a direção estética do arquivo `0-estetica-inicial.md`;
- botão de alternar tema claro/escuro somente se compatível com a direção estética definida em `0-estetica-inicial.md`; quando o arquivo definir tema único ou tokens específicos, respeitar essa decisão;
- botão de imprimir ou salvar em PDF;
- botão de exportar Markdown que converte todo o html em markdown;

---

# Estrutura visual obrigatória conforme `0-estetica-inicial.md`

Toda estrutura visual abaixo deve ser implementada obedecendo à direção estética oficial do produto, especialmente: identidade visual, paleta, tipografia, hierarquia, espaçamento, grids, densidade, componentes, estados, linguagem de interface, tokens visuais, padrões de layout, navegação, responsividade e microinterações descritos em `0-estetica-inicial.md`.
...
1. Alternar tema claro/escuro quando essa variação estiver prevista ou for compatível com `0-estetica-inicial.md`; caso contrário, manter o tema definido no arquivo estético e registrar a decisão.
...
# Estilo visual e UX/UI conforme `0-estetica-inicial.md`
...
1. Leia e interprete `0-estetica-inicial.md` antes de desenhar o dashboard.
...
4. Quando houver conflito entre uma preferência visual genérica deste prompt e o arquivo estético, o arquivo `0-estetica-inicial.md` prevalece.
...
Se `0-estetica-inicial.md` não estiver disponível:
...
- qualquer estilo incompatível com `0-estetica-inicial.md`.
...
- conter CSS no `<style>`;
- conter JS no `<script>`;
- ser legível, organizado e visualmente aderente a `0-estetica-inicial.md`;
...
<body>
  ...
  <main class="content" data-objetivo="Centralizar o conteúdo da Etapa 2, reunindo contexto, decisões, regras e entregas esperadas em um único ponto de referência para orientar a produção do artefato final e a continuidade do fluxo de trabalho.">
    <header class="hero">
    ...
    <section id="contexto-produto" data-objetivo="Detalhar Contexto do produto para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Contexto do produto -->
    </section>

    <section id="metodologia" data-objetivo="Detalhar Objetivo, escopo e metodologia da pesquisa para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Objetivo, escopo e metodologia da pesquisa -->
    </section>

    <section id="mapa-concorrentes" data-objetivo="Detalhar Mapa de concorrentes e referências para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Mapa de concorrentes e referências -->
    </section>

    <section id="players" data-objetivo="Detalhar Tabela consolidada de players para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Tabela consolidada de players -->
    </section>

    <section id="analises-detalhadas" data-objetivo="Detalhar Análise detalhada por sistema para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Análise detalhada por sistema -->
    </section>

    <section id="matriz-funcionalidades" data-objetivo="Detalhar Matriz comparativa de funcionalidades para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Matriz comparativa de funcionalidades -->
    </section>

    <section id="posicionamento" data-objetivo="Detalhar Matriz de posicionamento competitivo para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Matriz de posicionamento competitivo -->
    </section>

    <section id="publico-alvo" data-objetivo="Detalhar Análise de público-alvo por concorrente para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Análise de público-alvo por concorrente -->
    </section>

    <section id="propostas-valor" data-objetivo="Detalhar Análise de proposta de valor por concorrente para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Análise de proposta de valor por concorrente -->
    </section>

    <section id="modulos-funcionalidades" data-objetivo="Detalhar Módulos e funcionalidades recorrentes para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Módulos e funcionalidades recorrentes -->
    </section>

    <section id="ux-fluxos" data-objetivo="Detalhar Fluxos, telas e padrões de UX para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Fluxos, telas e padrões de UX -->
    </section>

    <section id="monetizacao" data-objetivo="Detalhar Modelos de monetização para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Modelos de monetização -->
    </section>

    <section id="integracoes" data-objetivo="Detalhar Integrações e ecossistema para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Integrações e ecossistema -->
    </section>

    <section id="diferenciais" data-objetivo="Detalhar Diferenciais competitivos para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Diferenciais competitivos -->
    </section>

    <section id="lacunas" data-objetivo="Detalhar Lacunas de mercado para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Lacunas de mercado -->
    </section>

    <section id="oportunidades" data-objetivo="Detalhar Oportunidades para o produto para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Oportunidades para o produto -->
    </section>

    <section id="riscos" data-objetivo="Detalhar Riscos competitivos e riscos de produto para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Riscos competitivos e riscos de produto -->
    </section>

    <section id="tendencias" data-objetivo="Detalhar Tendências relevantes para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Tendências relevantes -->
    </section>

    <section id="aprendizados" data-objetivo="Detalhar Aprendizados estratégicos para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Aprendizados estratégicos -->
    </section>

    <section id="hipoteses" data-objetivo="Detalhar Hipóteses atualizadas pela pesquisa para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Hipóteses atualizadas pela pesquisa -->
    </section>

    <section id="recomendacoes-etapa-3" data-objetivo="Detalhar Recomendações para a Etapa 3 para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
      <!-- Recomendações para a Etapa 3 -->
    </section>

    <section id="fontes" data-objetivo="Detalhar Fontes e referências para consolidar as informações necessárias desta seção, apoiar decisões da etapa e manter o artefato final coerente, acionável e fácil de validar.">
...
9. Salve o arquivo com o padrão `2.html`.
...
1. Ler a ideia, resumo ou HTML da etapa anterior e, quando disponível, o arquivo `0-estetica-inicial.md`.
...
7. Criar o dashboard HTML completo com UX/UI, temas, estilos, layouts e construção visual coerentes com `0-estetica-inicial.md`.

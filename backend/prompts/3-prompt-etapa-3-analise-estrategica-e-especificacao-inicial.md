...
Sua função é executar a **Etapa 3 — Análise Estratégica e Especificação Inicial** de um processo de construção de sistemas.
...
```txt
3-{nome-do-produto}.html
```

Exemplo:

```txt
3-analise-estrategica-e-especificacao-inicial-agentops.html
```
...
- definir uma visão funcional inicial;
- organizar domínios preliminares;
- sugerir módulos iniciais;
- mapear funcionalidades candidatas;
- indicar fluxos principais em alto nível;
...
A Etapa 3 é uma consolidação estratégica e funcional inicial, não a documentação final do sistema.
...
- direção estética do arquivo `0-estetica-inicial-{nome-do-produto}.md`.
...
## 8. Definir visão funcional inicial

Com base na pesquisa e na análise, proponha uma visão funcional inicial do sistema.
...
- fluxos principais em alto nível;
...
## 9. Mapear domínios preliminares
...
## 10. Mapear módulos candidatos

Crie uma tabela com:

| Domínio | Módulo | Descrição | Objetivo | Origem da necessidade | Prioridade inicial |
|---|---|---|---|---|---|

---

## 11. Mapear funcionalidades candidatas

Crie uma tabela com:

| Domínio | Módulo | Funcionalidade candidata | Descrição | Valor para o usuário | Evidência | Prioridade |
|---|---|---|---|---|---|---|

As funcionalidades devem ser candidatas, não requisitos finais.

---

## 12. Mapear fluxos principais em alto nível
...
12. **Domínios Preliminares**
13. **Módulos Candidatos**
14. **Funcionalidades Candidatas**
15. **Fluxos Principais em Alto Nível**
16. **Princípios de Produto**
17. **Diretrizes de UX/UI derivadas de `0-estetica-inicial-{nome-do-produto}.md`**
...
- quantidade de domínios preliminares;
- quantidade de módulos candidatos;
...
- total de domínios preliminares;
- total de módulos candidatos;
- total de funcionalidades candidatas;
...
<body>
  ...
  <main class="content">
    ...
    <section id="sintese-estrategica">
      <!-- Síntese estratégica -->
    </section>

    <section id="mercado-benchmarking">
    ...
    <section id="visao-funcional">
      <!-- Visão funcional inicial -->
    </section>
    ...
    <section id="recomendacoes-etapa-4">
      <!-- Recomendações para a Etapa 4 -->
    </section>
...
4. Não ignore o arquivo `0-estetica-inicial-{nome-do-produto}.md`.
...
12. Salve o arquivo com o padrão `3-{nome-do-produto}.html`.

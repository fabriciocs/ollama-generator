...
2. `9-{nome-do-produto}.html`;
3. `5-{nome-do-produto}.html`;
4. `4-{nome-do-produto}.html`;
5. `8-{nome-do-produto}.html`;
6. `6-{nome-do-produto}.html`;
7. `7-{nome-do-produto}.html`;
8. `3-{nome-do-produto}.html`;
9. `2-{nome-do-produto}.html`;
10. `1.2-{nome-do-produto}.html`;
11. `1-{nome-do-produto}.html`.
...
A apresentação visual desses controles deve seguir `0-estetica-inicial-{nome-do-produto}.md`.
...
31. **Diretrizes de UX/UI derivadas de `0-estetica-inicial-{nome-do-produto}.md`**
...
15. Não ignore o arquivo `0-estetica-inicial-{nome-do-produto}.md`, quando presente no ZIP.
...
<body>
  ...
  <main class="content">
    ...
    <section id="frontend-seguro">
      <!-- Controles para frontend e UX segura -->
    </section>

    <section id="dados-storage">
...
13. Não ignore a Etapa 8.
14. Não ignore a Etapa 9.
15. Não ignore o arquivo `0-estetica-inicial-{nome-do-produto}.md`, quando fornecido no ZIP.
16. Não crie estética paralela à estética oficial.
17. Não invente fontes, dados, riscos ou validações.
18. Não use links fictícios.
...
23. Salve o arquivo com o padrão `10-{nome-do-produto}.html`.

...
Adapte o wireframe ao tipo real de tela e ao arquivo `0-estetica-inicial-{nome-do-produto}.md`.
...
O tom deve seguir a direção estética e a linguagem definida em `0-estetica-inicial-{nome-do-produto}.md`.
...
7. Não ignore o arquivo `0-estetica-inicial-{nome-do-produto}.md`.
...
<body>
  ...
  <main class="content">
    ...
    <section id="detalhamento-fluxos">
    ...
    <section id="telas-por-fluxo">
      <!-- Telas por fluxo -->
    </section>

    <section id="estrutura-telas">
    ...
    <section id="padroes-interacao">
      <!-- Padrões de interação -->
    </section>

    <section id="permissoes-interface">
      <!-- Permissões refletidas na interface -->
    </section>

    <section id="ux-multitenant">
      <!-- UX Multi-Tenant, Multiempresa, Matriz e Filial -->
    </section>

    <section id="ux-billing">
    ...
    <section id="metricas-ux">
      <!-- Métricas de UX e Usabilidade -->
    </section>

    <section id="riscos-ux">
      <!-- Riscos de UX -->
    </section>
    ...
    <section id="recomendacoes-etapa-7">
      <!-- Recomendações para a Etapa 7 -->
    </section>
...
15. Salve o arquivo com o padrão `6-{nome-do-produto}.html`.

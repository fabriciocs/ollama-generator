...
6. localizar o arquivo `0-estetica-inicial-{nome-do-produto}.md`;
...
- `0-estetica-inicial-{nome-do-produto}.md` é o arquivo oficial de estética.
- `1.2-{nome-do-produto}.html` é a Etapa 1.2 de respostas pesquisadas para perguntas em aberto.
- Não confunda o arquivo `1.1-estetica` com a antiga nomenclatura `1.1-{nome-do-produto}.html`.
...
1. `0-estetica-inicial-{nome-do-produto}.md`;
2. `10-{nome-do-produto}.html`;
3. `9-{nome-do-produto}.html`;
4. `8-{nome-do-produto}.html`;
5. `7-{nome-do-produto}.html`;
6. `6-{nome-do-produto}.html`;
7. `5-{nome-do-produto}.html`;
8. `4-{nome-do-produto}.html`;
9. `3-{nome-do-produto}.html`;
10. `2-{nome-do-produto}.html`;
11. `1.2-{nome-do-produto}.html`;
12. `1-{nome-do-produto}.html`.
...
```txt
Arquivo 0-estetica-inicial-{nome-do-produto}.md não encontrado no ZIP. A direção visual abaixo é provisória e deve ser revisada quando a estética oficial estiver disponível.
```
...
4. Não confunda `0-estetica-inicial-{nome-do-produto}.md` com `1.2-{nome-do-produto}.html`.
...
16. Não ignore o arquivo `0-estetica-inicial-{nome-do-produto}.md`, quando presente no ZIP.
...
<body>
  ...
  <main class="content">
    ...
    <section id="resumo-executivo-final">
      <!-- Resumo executivo final -->
    </section>

    <section id="fontes-zip">
      <!-- Fontes extraídas do ZIP -->
    </section>

    <section id="inventario-arquivos">
    ...
    <section id="visao-final-produto">
      <!-- Visão final do produto -->
    </section>

    <section id="decisoes-consolidadas">
      <!-- Decisões consolidadas das etapas anteriores -->
    </section>

    <section id="escopo-funcional">
      <!-- Domínios, módulos e funcionalidades finais -->
    </section>

    <section id="fluxos-jornadas">
    ...
    <section id="dados-arquitetura-informacao">
      <!-- Modelo de dados e arquitetura da informação consolidada -->
    </section>

    <section id="arquitetura-tecnica">
      <!-- Arquitetura técnica consolidada -->
    </section>

    <section id="seguranca-governanca">
    ...
    <section id="plano-implementacao">
      <!-- Plano de implementação consolidado -->
    </section>

    <section id="qa-homologacao">
    ...
    <section id="operacao-suporte">
      <!-- Plano de operação e suporte -->
    </section>

    <section id="evolucao-produto">
    ...
    <section id="recomendacoes-finais">
      <!-- Recomendações finais -->
    </section>
...
14. Não ignore a Etapa 9.
15. Não ignore a Etapa 10.
16. Não ignore o arquivo `0-estetica-inicial-{nome-do-produto}.md`, quando fornecido no ZIP.
17. Não crie estética paralela à estética oficial.
18. Não invente fontes, dados, riscos ou validações.
19. Não use links fictícios.
...
24. Salve o arquivo com o padrão `11-{nome-do-produto}.html`.
...
3. Inventariar os arquivos extraídos.
4. Identificar os arquivos `.html` e `.md` das etapas anteriores.
5. Localizar e ler o arquivo `0-estetica-inicial-{nome-do-produto}.md`, quando existir.
